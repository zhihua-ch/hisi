...
typedef enum app_event_code
{
	...
	appEventVideofollow,  		//跟踪算法报警
	appEventVideoCrossline,		//越线算法报警
	appEventVideoCrossnet,		//侵入算法报警
	appEventVideoWanderdetect,			//徘徊算法报警
	appEventVideoConversedetect,	//逆行算法报警
	appEventVideoStaticdetect,		//遗留算法报警
	appEventVideoLostDetect,	//遗失算法报警
	appEventVideoDamagedetect,			//喷涂算法报警
#endif //end langzi
    appEventAll
}appEventCode;
